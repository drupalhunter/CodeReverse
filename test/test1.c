...
// gcc -m32 -O0 -o test1-gcc32.exe test1.c
// gcc -m64 -O0 -o test1-gcc64.exe test1.c
// cl /Od test1.c /Fetest1-vc32.exe
// cl /Od test1.c /Fetest1-vc64.exe
// bcc32 -etest1-bor32.exe -Od test1.c
// wcl386 -d0 -od -fe=test1-wat32.exe test1.c
#include <stdio.h>
